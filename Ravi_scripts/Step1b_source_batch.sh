...
subjBatchScriptDir="/projects/f_mc1689_1/DynamicSensoryMotorEGI/docs/scripts/Analysis3_causalFilter/subjbatch_preproc/"
...
do
    ...
    echo "matlab -nodisplay -r \"Step1_preproc_EGI_rest_task(${subjNum},${run_mode}), exit\"" >> $batchFilename
