...
if decodingAnalysis == 'DecodingAccuracy':
    ...
    plt.figure()
    plt.plot(timepoints, accuracy_avg, color='steelblue', linewidth=2)
    plt.fill_between(timepoints, accuracy_avg - accuracy_sem, accuracy_avg + accuracy_sem, alpha=0.3, color='lightskyblue')
