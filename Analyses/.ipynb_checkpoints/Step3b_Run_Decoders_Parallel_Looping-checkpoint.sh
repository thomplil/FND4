...
subjects="3"  # Single subject value, you can use an array as well for multiple subjects
scriptDir="/home/let83/FND4/Analyses/subjBatch_runSingleDecoder_Loop"
...
for subjNum in $subjects; do
    ...
    python_script_path="${scriptDir}/${subjNum}_single_decoder_script_loop.py"
...
classify_conditions = ['Hand','Left','Right']
subjNum = ${subjNum}
decoderTypeList = ['SVM','LDA','Random_Forest']
nTimepoints=250
for classify_cond in classify_conditions:
    for decoderType in decoderTypeList:
