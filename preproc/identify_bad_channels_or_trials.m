function [sub_bad, datasave] = identify_bad_channels_or_trials(subj, d, condition, meanabs_thresh, num_trls, tt_t, i, run_semiauto)
...
if length(bad) > 25
    disp(['WARNING: More than 25 channels exceed the noise threshold. Consider removing subject ', subj,'?']);
end
